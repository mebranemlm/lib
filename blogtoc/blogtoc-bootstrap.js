...
/*
     FILE ARCHIVED ON 10:22:35 ene 15, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 9:13:24 ago 6, 2016.
...
// Url: /web/20160115102235/http://beautifulbeta.blogspot.com
// Version: 2
// Date: 2007-04-12
// ---------------------------------------------------
// Modified by Aneesh 
...
function loadtoc(json) {
   ...
   // this functions reads all postdata from the json-feed and stores it in arrays
      if ("entry" in json.feed) {
         ...
         nextjsoncall.setAttribute("src", "https://ateismoparacristianos.blogspot.com/feeds/posts/summary?start-index=" + startindex + "&max-results=500&alt=json-in-script&callback=loadtoc");
...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      ...
      var tocNote = '<span class="toc-note">Mostrando ' + numDisplayed + ' entradas con la etiqueta \'';
      tocNote += postFilter + '\'.<br/>Total entradas publicadas: '+ postTitle.length + '<br/><a href="javascript:filterPosts(\'\')">Mostrar todos</a></span>';
   }
...
function hideToc() {
  ...
  tocdiv.innerHTML = '';
  var toclink = document.getElementById("toclink");
  toclink.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle('+"'toc-result','blind');"+'">» Show Table of Contents</a> <img src="/web/20160115102235/http://chenkaie.blog.googlepages.com/new_1.gif"/>';
}
